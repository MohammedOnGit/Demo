...
//   const handleCopy = () => {
//     const fullAddress = `${address}, ${city}, ${digitalAddress}`;
...
//       "group border hover:border-primary/50",
...
//       {/* Type Indicator */}
//       <div className={cn("absolute top-0 left-0 h-full w-1.5", config.bg)} />
...
//                 <p className="text-sm bg-amber-50 text-amber-900 px-3 py-2 rounded-lg border border-amber-200">
//                   {notes}
//                 </p>
//               </div>
//             </div>
...
//             variant="ghost"
//             size="sm"
//             className="flex-1 sm:flex-none gap-2 text-primary"
...
// components/shoping-view/address-card.jsx - UPDATE THIS FILE
import React from "react";
import { Card, CardContent, CardFooter } from "../ui/card";
import { Button } from "../ui/button";
import { 
...
function AddressCard({ 
  ...
  return (
    <Card className={cn(
      ...
      "group border hover:border-primary/50",
      isDefault && "ring-2 ring-primary ring-offset-2",
      isSelected && "ring-2 ring-green-500 ring-offset-2 border-green-300", // ADD THIS
      className
    )}>
      {/* Selection Checkmark */}
      {isSelected && (
