...
//       side="right"
//       className={cn(
//         "w-full sm:max-w-md h-full flex flex-col p-0",
//         isClosing && "opacity-0"
//       )}
//     >
//       {/* Header */}
...
//             Add {format(remainingForFreeShipping)} for free shipping
//           </p>
//         )}
//       </SheetHeader>
...
function UserCartWrapper({ cartItems = [] }) {
  ...
  // Checkout: Just navigate — Sheet is unmounted by header conditional render
  const checkout = useCallback(() => {
