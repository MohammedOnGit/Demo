        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                ? "text-primary bg-linear-to-r from-primary/10 to-primary/20 md:bg-transparent font-semibold"
                : "text-muted-foreground hover:text-primary",
              isMobile && "w-full",
              !isMobile && "px-3 mx-1"
            )}
          ...
          >
            ...
            {isActive && !isMobile && (
              <div className="hidden md:block h-0.5 w-full bg-linear-to-r from-primary via-primary/70 to-primary/40 rounded-full mt-1" />
            )}
          </button>
        );
      })}
    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" className="gap-2 px-2 h-10 hover:bg-muted/50">
            <Avatar className="h-8 w-8 ring-2 ring-primary/20 transition-transform hover:scale-105">
              <AvatarFallback className="bg-linear-to-br from-amber-500 to-rose-500 text-white font-semibold">
                {user?.userName?.[0]?.toUpperCase() || "U"}
              </AvatarFallback>
            </Avatar>
            <div className="hidden lg:flex flex-col items-start">
        ...
        <DropdownMenuContent align="end" className="w-64">
          <DropdownMenuLabel className="font-normal">
            <div className="flex flex-col space-y-2 p-2">
              <div className="flex items-center gap-3">
                <Avatar className="h-12 w-12 ring-2 ring-primary/20">
                  <AvatarFallback className="bg-linear-to-br from-amber-500 to-rose-500 text-white text-lg">
                    {user?.userName?.[0]?.toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                <div className="flex-1 min-w-0">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-4">
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              >
                ...
                <div className="sticky top-0 z-10 bg-background border-b px-4 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-linear-to-br from-amber-500 to-rose-500 flex items-center justify-center">
                        <span className="text-white font-bold text-lg">A</span>
                      </div>
                      <div>
                        <p className="font-bold text-lg">adeeB</p>
            ...
            >
              <div className="relative">
                <div className="h-9 w-9 rounded-full bg-linear-to-br from-amber-500 to-rose-500 flex items-center justify-center transition-transform group-hover:scale-105 group-hover:rotate-12">
                  <span className="text-white font-bold text-lg">A</span>
                </div>
                <div className="absolute -inset-1 rounded-full bg-linear-to-r from-amber-500 to-rose-500 opacity-0 group-hover:opacity-20 blur transition-opacity" />
              </div>
              <div className="hidden sm:flex flex-col">
                <span className="font-serif text-xl font-bold tracking-tight bg-linear-to-r from-amber-600 to-rose-600 bg-clip-text text-transparent">
                  adeeB
                </span>
                <span className="text-[10px] text-muted-foreground tracking-widest uppercase">
                  PERFUMES
