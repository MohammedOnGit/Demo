...
// /* ---------- Constants ---------- */
// const STATUS_OPTIONS = ["all", "pending", "processing", "confirmed", "shipping", "delivered", "cancelled"];
// const statusConfig = {
//   pending: { label: "Pending", color: "bg-amber-100 text-amber-800", icon: Clock },
//   processing: { label: "Processing", color: "bg-blue-100 text-blue-800", icon: Package },
//   confirmed: { label: "Confirmed", color: "bg-purple-100 text-purple-800", icon: ShieldCheck },
...
//           (statusFilter === "shipped" && order.status === "shipping")) {
//         matchesStatus = true;
//       }
...
/* ---------- Constants ---------- */
const STATUS_OPTIONS = ["all", ...orderStatuses];
