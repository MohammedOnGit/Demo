...
export const addressFormControls = [
  ...
  },
  {
    ...
    componentType: "input",
    type: "text",
    placeholder: "e.g., NT-0126-1440 (GhanaPostGPS format)",
    required: true,
    helperText: "Format: DistrictCode-XXXX-XXXX (e.g., AK-644-6263, NT-0126-1440)",
  },
  {
    label: "Phone",
    name: "phone",
    ...
    required: true,
    helperText: "Ghana phone numbers only (MTN, Vodafone, AirtelTigo, Glo)",
  },
  {
    label: "Notes",
    name: "notes",
    componentType: "textarea",
    placeholder: "Delivery instructions or additional notes (optional)",
  },
];
