...
function AdminProducts() {
  ...
  }, [formData, imageLoadingState, uploadedImageUrl, currentEditedId, dispatch, resetForm]);
  ...
  const isFormInvalid = !formData.title || !formData.price || !formData.category || !formData.totalStock;
