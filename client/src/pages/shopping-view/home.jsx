...
//   // ---------------- NAVIGATION ----------------
//   const handleNavigateToCategoryListingPage = (item, section) => {
//     const query = new URLSearchParams();
//     query.set(section, item.id);
...
//                 key={item.id}
//                 onClick={() =>
//                   handleNavigateToCategoryListingPage(item, "category")
//                 }
//                 className="cursor-pointer hover:shadow-lg transition"
//               >
//                 <CardContent className="flex flex-col items-center p-6">
//                   <item.icon className="w-10 h-10 mb-3 text-gray-700" />
...
//                 key={item.id}
//                 onClick={() =>
//                   handleNavigateToCategoryListingPage(item, "brand")
//                 }
//                 className="cursor-pointer hover:shadow-lg transition"
//               >
//                 <CardContent className="flex flex-col items-center p-6">
...
const AUTOPLAY_DELAY = 5000;
const TRANSITION_DURATION = 700;
const MAX_FEATURED_PRODUCTS = 8; // Limit number of featured products on homepage
...
export default function ShoppingHome() {
  ...
  const featuredProducts = products
    ? products.filter((product) => product.isFeatured).slice(0, MAX_FEATURED_PRODUCTS)
    : [];
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-6">
            ...
            <Button onClick={handleViewAllProducts} variant="link">
              View All Products
            </Button>
          </div>
