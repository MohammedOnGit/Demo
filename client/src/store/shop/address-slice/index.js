...
// // src/store/shop/address-slice.js
// import { createSlice, createAsyncThunk } from "@reduxjs/toolkit";
// import axios from "../../../utils/axios-interceptor"; // <-- your configured instance
...
//     try {
//       const response = await axios.post(
//         "/shop/address/add", // relative to baseURL
//         formData
//       );
//       return response.data.data;
//     } catch (error) {
...
//   async (_, thunkAPI) => {
//     try {
//       const response = await axios.get("/shop/address/get");
//       return response.data.data;
//     } catch (error) {
//       return thunkAPI.rejectWithValue(
//         error.response?.data?.message || "Failed to fetch addresses"
...
//   async (addressId, thunkAPI) => {
//     try {
//       await axios.delete(`/shop/address/delete/${addressId}`);
//       return addressId;
//     } catch (error) {
//       return thunkAPI.rejectWithValue(
//         error.response?.data?.message || "Failed to delete address"
...
import { createSlice, createAsyncThunk } from "@reduxjs/toolkit";
import axios from "../../../utils/axios-interceptor"; // <-- configured interceptor with baseURL from env
...
export const addNewAddress = createAsyncThunk(
  ...
  async (formData, thunkAPI) => {
    try {
      const response = await axios.post(
        "/shop/address/add", // relative to baseURL from interceptor
        formData
      );
      return response.data.data;
    } catch (error) {
