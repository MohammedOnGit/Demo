...
// Helper to get token from localStorage (matching your authSlice storage)
const getAuthToken = () => {
  return localStorage.getItem('app_token'); // Matches your SecureStorage prefix
};
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchWishlist.rejected, (state, action) => {
        ...
        // Clear wishlist on authentication errors
